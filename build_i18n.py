...
add('agency.full',
 ...
 '<h2>Захищений патерн</h2><p>Сніжинка має структуру й втрачає її, щойно теплішає. Клітина має структуру й утримує її протягом усього існування: лагодить мембрану, перекачує йони, регулює власну хімію, поглинає поживні речовини, виводить відходи. Патерн є в обох випадках. Різниця в тому, що клітина фіксує відхилення від життєздатного стану й протидіє їм. Агентність народжується там, де стійкість перетворюється на активне самовідновлення.</p>'
