...
add('dek','A model of how structure becomes stable, then alive, then sentient. And how that same machinery turns an idea into a trap.',
...
add('lede.short',
 'This map is a guide from the simple patterns of nature to the human mind and the traps of ideology. I take pattern &mdash; the capacity to compress information &mdash; as the primitive, and follow how far one ladder climbs: from a crystal, to a cell that defends itself, to a mind that plans ahead.<br><br><strong>How to read the map:</strong> move left to right along the main spine (from Pattern to Mind), or tap the cards to open the full essays. To begin, pick the first card, &ldquo;The ladder.&rdquo;',
 'Цю мапу я зробив, щоб нею думати. Ставка проста: узяти патерн за вихідне поняття й подивитися, як високо здіймаються одні сходи &mdash; від чистої структури до агентів, що її обороняють, і до розумів, які уявляють, чим іще можуть стати. Патерн &mdash; це будь-що, що можна описати коротше, ніж його прояви. Там, де підйом зупиняється, видно не менше, ніж там, де вони тримають.',
 'Эту карту я сделал, чтобы ею думать. Ставка проста: взять паттерн за исходное понятие и посмотреть, как высоко ведёт одна лестница &mdash; от чистой структуры к агентам, что её отстаивают, и к разумам, которые представляют, чем ещё могут стать. Паттерн &mdash; это всё, что можно описать короче, чем его проявления. Там, где подъём останавливается, видно не меньше, чем там, где он держит.')
add('lede.full',
 'I built this map to solve one problem: we are used to keeping physical structures, living organisms, art, and ideologies in separate drawers, and that makes the picture of the world feel fragmented. My wager is to take <strong>pattern</strong> as the fundamental unit and trace how far one ladder climbs.<br><br><strong>From pattern to mind, in the life of a single cell:</strong><ul><li><b>Pattern:</b> chemical concentrations in water &mdash; a bare regularity.</li><li><b>Attractor:</b> the chemistry loops back on itself and holds steady over time.</li><li><b>Form:</b> a membrane walls that reaction off from the surrounding chaos, embodying it in matter.</li><li><b>Agency:</b> the cell pumps ions, patches its membrane, and swims toward nutrients to protect its form.</li><li><b>Mind:</b> the organism builds a model of its environment and reckons with obstacles before they arrive.</li></ul><br>Where the climb stops matters as much as the rungs that bear the weight. A richer inner model buys more agency, and it also opens room for error: the mind is easily fooled by an elegant compression &mdash; a conspiracy theory, a dogma &mdash; that settles in beautifully while never touching the real world.',
 'Цю мапу я роблю, щоб нею думати. Ставка пряма: беру патерн за вихідне поняття й дивлюся, як високо здіймаються одні сходи &mdash; від чистої структури до агентів, що її обороняють. Там, де підйом зупиняється, видно не менше, ніж там, де він тримає. Чимало речей, які ми тримаємо по різних шухлядах &mdash; фізична форма, біологічна агентність, краса, розум, ідеологія, &mdash; зрештою живуть на цих самих сходах. Патерн тут &mdash; це закономірність, яку можна описати коротше за перелік її проявів, відносно якоїсь моделі чи коду. Синусоїда, кристалічна ґратка, октава, морфогенетичне поле: кожне &mdash; короткий опис, що заступає те, на що інакше пішла б ціла вічність.',
 'Эту карту я строю, чтобы ею думать. Ставка прямая: беру паттерн за исходное понятие и смотрю, как высоко ведёт одна лестница &mdash; от чистой структуры к агентам, что её отстаивают. Там, где подъём останавливается, видно не меньше, чем там, где он держит. Многое, что мы держим по разным полкам &mdash; физическая форма, биологическая агентность, красота, разум, идеология, &mdash; в итоге живёт на этой же лестнице. Паттерн здесь &mdash; это закономерность, которую можно описать короче, чем перечень её проявлений, относительно некоторой модели или кода. Синусоида, кристаллическая решётка, октава, морфогенетическое поле: каждое &mdash; короткое описание, заменяющее то, на что иначе ушла бы вечность.')
...
add('ladder.short',
 ...
 '<h2>П&rsquo;ять сходинок</h2><ul class="ladder">'
 ...
 '<li><b>Агентність</b> &mdash; <span>форма, що сама себе обороняє під збуренням.</span></li>'
 '<li><b>Розум</b> &mdash; <span>агентність, яка моделює патерни, котрих ще не має.</span></li>'
 '</ul><p>Кожна сходинка додає те, чого бракує сходинці під нею.</p>',
...
add('ladder.full',
 ...
 '<li><b>Агентність</b> &mdash; <span>активне збереження форми чи цільового стану під збуренням.</span></li>'
 '<li><b>Розум</b> &mdash; <span>агентність, що в умовному способі прораховує можливі патерни.</span></li>'
 '</ul><p>Кожна сходинка додає те, чого бракує сходинці під нею. Саме тому сходи кращі за гасло &laquo;усе є патерн&raquo;, яке не пояснює нічого. Одне слово, що повертатиметься далі, варто застерегти. У строгому сенсі &mdash; тому, який уточнює нелінійна динаміка, &mdash; <em>атрактор</em> потребує простору станів і динаміки: множини, до якої сходяться траєкторії. Буквально я вживаю його лише там, де їх можна задати; для розумів і культур &mdash; як виважену аналогію.</p>',
...
add('logic.short',
 ...
 '<h2>Перший фільтр</h2><p>Межу окреслює логіка ще до фізики: квадратне коло не збудують ніколи. Фільтри вкладені один в одного &mdash; <strong>логічно можливе &sup; динамічно стійке &sup; утілене в матерії &sup; самозахисне</strong> &mdash; і кожна сходинка лежить усередині попередньої.</p>',
...
add('logic.full',
 ...
 '<p>Фільтри вкладені: <strong>логічно можливе &sup; динамічно стійке &sup; утілене в матерії &sup; самозахисне</strong>. Кожна сходинка цих сходів лежить усередині попередньої.</p>'
 '<p>Одне застереження тримає цю думку чесною. Коли хвиля і частинка чи клітина, що водночас кооперує та конкурує, видаються суперечливими, опис зазвичай надто грубий для того рівня, який охоплює; вигостри модель &mdash; і сутичка розчиняється. Справжня суперечність забороняє; уявна лише просить кращої моделі.</p>',
...
add('agency.full',
 ...
 '<h2>Захищений патерн</h2><p>Сніжинка має структуру й втрачає її, щойно теплішає. Клітина має структуру й утримує її протягом усього існування: лагодить мембрану, перекачує іони, регулює власну хімію, поглинає поживні речовини, виводить відходи. Патерн є в обох випадках. Різниця в тому, що клітина фіксує відхилення від життєздатного стану й протидіє їм. Агентність народжується там, де стійкість перетворюється на активне самовідновлення.</p>'
...
add('compute.full',
 ...
 '<p>Computation happens beyond the brain too. Following Levin&rsquo;s work on bioelectricity, even cells without synapses use electrical signals to determine the body&rsquo;s form. This is the thread from thought to morphology. The cell regulates its states in a problem space without reasoning or feeling. This is cognition in its simplest, basic form. The search has structure: past patterns prune the options, directing the system along an allowed corridor. This reduces energy costs, making computation possible.</p>'
 ...
 '<h2>Логіка поза субстратом</h2><p>Обчислення не прив&rsquo;язане до субстрату: ті самі дії йдуть на іонних каналах, на транзисторах чи на хвилях, де резонанс додає, а гасіння віднімає. Логіка переносна; Всесвіт бере за неї плату. Кожна справжня машина оплачує рахунок свого субстрату &mdash; енергією, швидкістю, похибкою.</p>'
 '<p>Обчислення відбуваються й поза межами мозку. У дослідженнях біоелектрики Майкла Левіна клітини без синапсів оперують електричними сигналами, визначаючи форму майбутнього тіла. Це нитка від думки до морфології. Клітина регулює власні стани в просторі задач, не мислячи й не відчуваючи. Це пізнання в його найпростішій, базовій формі. Пошук має структуру: попередні патерни звужують простір варіантів, спрямовуючи систему дозволеним коридором. Це зменшує витрати енергії, уможливлюючи самі обчислення.</p>'
 ...
 '<p>Вычисления происходят и за пределами мозга. В исследованиях биоэлектричества Майкла Левина клетки без синапсов оперируют электрическими сигналами, определяя форму будущего тела. Это нить от мысли к морфологии. Клетка регулирует свои состояния в пространстве задач, не мысля и не чувствуя. Это познание в его простейшей, базовой форме. Поиск имеет структуру: прошлые паттерны сужают спектр вариантов, направляя систему по разрешённому коридору. Это снижает энергозатраты, позволяя вычислениям происходить.</p>'
...
add('beauty.full',
 ...
 '<p>Одна из возможностей, и тут я иду за Шмидхубером, в том, что чувство следит скорее за тем, как быстро модель улучшается, чем за тем, сколько строя уже есть. Красота, возможно, отмечает прогресс сжатия: миг, когда модель ширится, не ломаясь. Сжатия, что остаются прекрасными, обычно достаточно просты, чтобы их ухватить, достаточно богаты, чтобы их разведывать дальше, и достаточно полезны, чтобы предсказать следующий миг. Это лишь предположение: классическая концепция перевёрнутой U-образной кривой Берлайна, связывающая интерес с новизной и сложностью, работает лишь в отдельных областях.</p>'
...
add('reality.full',
 ...
 '<p>The test works regardless of where you land on the metaphysics. Science and propaganda both compress the world; the difference lives in what each does next. Good compression lets reality correct it; bad compression explains the correction away.</p>',
...
add('selection.full',
 ...
 '<p>Те, що патерн може існувати, не каже нічого про те, чи треба його будувати. Які патерни варто втілювати &mdash; це окреме питання, яке ми тут ще не розбирали. Передбачення &mdash; це підлога; вибору у фізиці немає.</p>'
 ...
 '<p>То, что паттерн может существовать, не говорит ничего о том, нужно ли его строить. Какие паттерны стоит воплощать &mdash; это отдельный вопрос, который мы здесь ещё не разбирали. Предсказание &mdash; это нижняя граница; выбора в физике нет.</p>'
...
add('open.body',
 ...
 '<p class="q">Is pattern a subjective grid the mind throws over reality, or the objective fabric the world is woven from?</p>'
 '<p class="q">Is there a sharp boundary where &ldquo;agency&rdquo; begins, or only a continuous spectrum with no clean line on it?</p>'
 '<p class="q">Is beauty the direct sensation of a form settling into a mind &mdash; the very same event lived from the inside?</p>'
 '<p class="q">Is logic an outer frame on the space of all possible patterns, or the deepest first-pattern of all, the one every rung of this ladder grows from?</p>',
...
<div class="col">
  <div class="lede reveal d2 v-short" data-i18n="lede.short">__LEDESHORT__</div>
  <div class="lede reveal d2 v-full" data-i18n="lede.full">__LEDEFULL__</div>
</div>
...
<div class="modal-overlay" id="cardModal" aria-hidden="true" role="dialog" aria-modal="true">
  <div class="modal-content" id="modalContent">
    ...
    <div class="modal-nav">
      <button type="button" id="modalPrev" class="modal-nav-btn">← <span class="nav-title"></span></button>
      <button type="button" id="modalNext" class="modal-nav-btn"><span class="nav-title"></span> →</button>
    </div>
  </div>
</div>
"""
